        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers("/api/auth/**").permitAll()  // .permitAll() : 모두 허용한다 = 여기에 해당하는 것들은 검사하지 마라
                ...
                // 토큰을 검사하는 커스텀 인증 필터를 시큐리티에 등록
                .addFilterBefore(jwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class)

                
                // 시큐리티 기본 인증 인가 차단의 상태 코드는 403으로 지정되어있음
                // 그런데 403은 인가차단이지 인증차단코드가 아님, 인증 차단은 401로 해야 적합함
