...
<main class="auth-layout">
  <div class="auth-form-container">
    ...
    <div class="auth-card">
      ...
      <!-- 설명 텍스트 -->
      <p class="signup-text">친구들의 사진과 동영상을 보려면 가입하세요.</p>
      ...
      <form class="auth-form" novalidate>
        ...
        <div class="form-field">
          <div class="input-container">
            ...
            <button type="button" class="password-toggle">패스워드 표시</button>
          </div>
        </div>
        ...
        <button type="submit" class="auth-button">가입</button>
      </form>
    </div>
    ...
    <div class="app-download">
      ...
      <div class="app-download-buttons">
        <a href="#" class="app-store">
          <img src="https://static.cdninstagram.com/rsrc.php/v4/yi/r/cWx_hQBPmbo.png" alt="App Store에서 다운로드">
        </a>
        <a href="#" class="google-play">
          <img src="https://static.cdninstagram.com/rsrc.php/v4/ye/r/UtJtFmFLCiD.png"
